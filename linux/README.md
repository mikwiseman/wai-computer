...
By default the script stages packages under `artifacts/releases/linux/<version>-<channel>/packages`. To publish to the VPS release directory, set `LINUX_RELEASE_PUBLISH=1 VPS_USER=<release-user>`.
