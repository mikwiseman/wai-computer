...
/// (promote into canonical memory) or reject (durable — never re-proposed).
struct ReviewView: View {
    ...
    init(apiClient: APIClient) {
        ...
        _model = StateObject(wrappedValue: ReviewViewModel(apiClient: apiClient))
    }
    ...
    var body: some View {
        ...
        .navigationTitle(t("Review", "На проверку"))
    ...
    private func card(_ proposal: MemoryProposal) -> some View {
    ...
    private func errorText(_ error: ReviewViewModel.ReviewError) -> String {
        switch error {
        case .load:
