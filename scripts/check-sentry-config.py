...
EXPECTED_PROJECT_IDS = {
    "backend": "<sentry-project-id>",
    "ios": "<sentry-project-id>",
    "macos": "<sentry-project-id>",
    "web": "<sentry-project-id>",
    "windows": "<sentry-project-id>",
    "android": "<sentry-project-id>",
    "linux": "<sentry-project-id>",
}
...
def main() -> None:
    ...
    backend_env_pattern = re.compile(r"SENTRY_DSN=.*<sentry-project-id>")
