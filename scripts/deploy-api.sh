...
ssh_remote \
  "${REMOTE_SERVER_BUILD_ENV} PROD_ROOT='${REMOTE_ROOT}' PROD_ENV_FILE='${REMOTE_ENV_FILE}' GIT_SHA='${GIT_SHA}' GIT_DIRTY='${GIT_DIRTY}' WAICOMPUTER_BACKEND_IMAGE='${WAICOMPUTER_BACKEND_IMAGE}' WAICOMPUTER_WEB_IMAGE='${WAICOMPUTER_WEB_IMAGE}' ALLOW_ACTIVE_TRANSCRIPTION_DEPLOY='${ALLOW_ACTIVE_TRANSCRIPTION_DEPLOY}' bash '${REMOTE_ROOT}/scripts/server-build.sh'"
