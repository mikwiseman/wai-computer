...
data class UserSettings(
    ...
    @SerialName("dictation_live_stt_provider") val dictationLiveSttProvider: String = "openai",
    @SerialName("dictation_live_stt_model") val dictationLiveSttModel: String = "gpt-realtime-whisper",
    @SerialName("recording_live_stt_provider") val recordingLiveSttProvider: String = "openai",
    @SerialName("recording_live_stt_model") val recordingLiveSttModel: String = "gpt-realtime-whisper",
