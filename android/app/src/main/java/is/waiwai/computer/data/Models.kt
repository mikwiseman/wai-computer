...
data class UserSettings(
    ...
    @SerialName("recording_live_stt_provider") val recordingLiveSttProvider: String = "soniox",
    @SerialName("recording_live_stt_model") val recordingLiveSttModel: String = "stt-rt-v4",
