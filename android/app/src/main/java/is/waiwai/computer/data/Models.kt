...
data class UserSettings(
    ...
    @SerialName("dictation_live_stt_provider") val dictationLiveSttProvider: String = "inworld",
    @SerialName("dictation_live_stt_model") val dictationLiveSttModel: String = "inworld/inworld-stt-1",
    @SerialName("recording_live_stt_provider") val recordingLiveSttProvider: String = "inworld",
    @SerialName("recording_live_stt_model") val recordingLiveSttModel: String = "inworld/inworld-stt-1",
