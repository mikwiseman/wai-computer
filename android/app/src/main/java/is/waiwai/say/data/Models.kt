...
data class UserSettings(
    ...
    @SerialName("dictation_live_stt_provider") val dictationLiveSttProvider: String = "elevenlabs",
    @SerialName("dictation_live_stt_model") val dictationLiveSttModel: String = "scribe_v2_realtime",
    ...
    @SerialName("dictation_post_filter_model") val dictationPostFilterModel: String = "claude-3-5-haiku-20241022",
)
