...
/// Settings section to connect ANY third-party MCP server as an ingestion
/// source — WaiComputer pulls that server's data into the brain. Distinct from
/// the inbound connector instructions (which connect external apps TO Wai).
            ...
            VStack(alignment: .leading, spacing: Spacing.xxs) {
                ...
                HStack(spacing: Spacing.xs) {
                    ...
                    if let last = connection.lastError {
                        Text(last).font(Typography.labelSmall).foregroundStyle(Palette.recording)
                    }
                }
            }
            Spacer()
