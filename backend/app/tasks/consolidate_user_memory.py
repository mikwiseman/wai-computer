...
CONSOLIDATOR_SYSTEM_PROMPT = (
    ...
    "single-day tasks, momentary feelings, and trivia. Do not emit project, "
    "company, customer, sales, product, source-summary, or operational facts "
    "into user memory; those belong in Brain knowledge, not personal memory. "
    "Use topics only for long-lived recurring user interests, never for one "
    "project track or source name. For each update give "
